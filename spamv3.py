...
╭────────────────────────────────────────────────────────────────────╮""")) + (gradient_2("""
│""")) + (gradient_1("=> Admin : Light")) + (gradient_2("                                                    │")) + (gradient_2("\n│")) + (gradient_1("=> Youtube : @LightCodingTool")) + (gradient_2("                                       │")) + (gradient_2("""\n│""")) + (gradient_1("=> Group Support : https://zalo.me/g/vvlcni708")) + (gradient_2("                      │")) + (gradient_2("""\n│""")) + (gradient_1("=> Zalo Admin : 0384620729")) + (gradient_2("                                          │")) + (gradient_2("\n│")) + (gradient_1("=> TikTok : No Acc")) + (gradient_2("""                                                  │""")) + (gradient_2("""
╰────────────────────────────────────────────────────────────────────╯"""))
...
def run(phone, i):
    ...
    print("\033[1;32mSpam thành công lần :", i)
    for j in range(4, 0, -1):
        print(f"\033[1;32mVui lòng chờ {j} giây", end="\r")
        time.sleep(1)

if __name__ == "__main__":
    print("\033[1;36mTool Spam Sms + Call Vip\033[0m")  # Màu xanh dương đậm
    phone = input("\033[1;32mNhập số điện thoại:\033[1;33m ")
  
    count = int(input("\033[1;32mNhập số lần spam:\033[1;33m "))
