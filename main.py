...
def load_or_get_cookie():
    ...
    cookie = input(gradient_tutu("""\n╭─────[ Nhập Cookie Facebook ] - [ Light - Lê Hoàng Giang ]
│ 
╰─➤   """)).strip()
    if check_cookie(cookie):
...
def menu():
    ...
    while True:
        ...
        print("    \033[1;31m ╔═                                        ═╗")
        print(gradient("       ┌──────────────────────────────────────┐"))
        print(gradient("       │   Credits : Light - Lê Hoàng Giang   │"))
        print(gradient("       └──────────────────────────────────────┘"))
        print("    \033[1;31m ╚═                                        ═╝")
        print(gradient("\n╔════════════════════════════════════════════╗"))
        print(gradient("║       🤖 MENU BOT MESSENGER BY LIGHT       ║"))
        print(gradient("╠════════════════════════════════════════════╣"))
        ...
        choice = input(gradient_tutu("""╭─────[ Nhập Lựa Chọn ] - [ Light - Lê Hoàng Giang ]
│ 
╰─➤  """))
        ...
        try:
            delay = int(input(gradient_tutu("""\n╭─────[ Nhập Delay ] - [ Light - Lê Hoàng Giang ]
│ 
╰─➤   """)))
        except:
            delay = 5
        ...
        if choice == "1":
            ...
            thread_id = input(gradient_tutu("""\n╭─────[ Nhập ID Nhóm ] - [ Light - Lê Hoàng Giang ]
│ 
╰─➤  """))
            message_file = input_with_box(gradient_tutu("""\n╭─────[ Nhập File Chứa Ngôn ] - [ Light - Lê Hoàng Giang ]
│ 
╰─➤   """))
